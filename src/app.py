...
activities = {
    ...
    "Basketball Club": {
        "description": "Improve shooting, defense, and game strategy in a competitive setting",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Drama Club": {
        "description": "Act, perform scenes, and explore theatrical techniques",
    ...
    "Math Olympiad": {
        "description": "Solve advanced math problems and compete in team challenges",
